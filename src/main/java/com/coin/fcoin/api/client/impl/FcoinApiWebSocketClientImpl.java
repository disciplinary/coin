package com.coin.fcoin.api.client.impl;
...
public class FcoinApiWebSocketClientImpl implements FcoinApiWebSocketClient {
    ...
    public Closeable onTicker(String symbol, ApiCallback<TickerResp> callback) {
        ...
        return createNewWebSocket(topic, new com.fcoin.api.client.impl.FcoinApiWebSocketListener<>(callback, TickerResp.class));
    }
    ...
    public Closeable onDepth(DepthLevel level, String symbol, ApiCallback<DepthResp> callback) {
        ...
        return createNewWebSocket(topic, new com.fcoin.api.client.impl.FcoinApiWebSocketListener<>(callback, DepthResp.class));
    }
    ...
    public Closeable onCandle(Resolution resolution, String symbol, ApiCallback<CandleResp> callback) {
        ...
        return createNewWebSocket(topic, new com.fcoin.api.client.impl.FcoinApiWebSocketListener<>(callback, CandleResp.class));
    }
    ...
    public Closeable onTrade(String symbol, ApiCallback<TradeResp> callback) {
        ...
        return createNewWebSocket(topic, new com.fcoin.api.client.impl.FcoinApiWebSocketListener<>(callback, TradeResp.class));
    }

    private Closeable createNewWebSocket(String sub, com.fcoin.api.client.impl.FcoinApiWebSocketListener<?> listener) {
