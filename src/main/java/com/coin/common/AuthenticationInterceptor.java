...
import com.coin.fcoin.api.client.security.HmacSHA1Signer;
...
public class AuthenticationInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
       ...
       // if (isSignatureRequired) {
            ...
            newRequestBuilder.addHeader("accessKey", apiKey);
            newRequestBuilder.addHeader("reqTime", now.toString());
            newRequestBuilder.addHeader("sign", signature);
       // }
