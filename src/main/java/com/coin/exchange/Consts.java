 ...
 */
public class Consts {
    public static final  String API_HOST = "api.bitcola.io";
    public static final   String API_URL = "https://" + API_HOST;
    public static final   String WS_API_BASE_URL_PRO = "wss://api.fcoin.com/v2/ws";
    ...
    public static final  String ENDPOINT_SECURITY_TYPE_SIGNED = "FC-ACCESS-SIGNATURE";
